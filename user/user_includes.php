...
if (isset($_SESSION['login'])) {
    ...
    if (isset($_POST['profil_submit'])) {
        ...
        foreach ($_POST as $post) { unset($post); }
        $userdata = api_get($_SESSION['login']['usertoken'], '?users=datas');
        $_POST['profil_username']=$userdata->username; $_POST['profil_useremail']=$userdata->useremail; $_POST['profil_userinfo']=$userdata->userinfo; $_POST['profil_radio']=$userdata->imglink; $_POST['profil_password']=""; $_POST['profil_repassword']=""; // $_POST['profil_passwordcheck']="";
    }
}
