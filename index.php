...
<body>
    <div class="container-fluid page mt-2">
        <div class="row head p-3 rounded-top">
            <div class="col-6"><h1 class="link"><a href="index.php?inc=home">MD Blog</a></h1><h2 class="link"><a href="index.php?inc=home">Portal</a></h2></div>
            <div class="logo"></div>
        </div>
