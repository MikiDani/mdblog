...
if (isset($_POST['myblog_submit'])) {
    ...
    //echo $_POST['myblog_categoryid']."<br>"; echo $_POST['myblog_name']."<br>"; echo $_POST['myblog_title']."<br>";
...
if (isset($_POST['entriemod_submit'])) {
    ...
    //echo "ID: ".$_POST['entriemod_entrieid']."<br>"; echo $_POST['entriemod_title']."<br>"; echo $_POST['entriemod_body']."<br>";
    ...
    if (isset($_POST['entriemod_title']) && isset($_POST['entriemod_body']) && $_POST['entriemod_title']!='' && $_POST['entriemod_body']!='') {
        ...
        // make epoch time to save // hour, minute, second, month, day, year );
        // echo "year: ".$_POST['entriemod_year']."<br>"; echo "month: ".$_POST['entriemod_month']."<br>"; echo "day: ".$_POST['entriemod_day']."<br>"; echo "hour: ".$_POST['entriemod_hour']."<br>"; echo "minute: ".$_POST['entriemod_minute']."<br>"; echo "second: ".$_POST['entriemod_second']."<br>";
...
if (isset($_POST['entriemodcheck_submit'])) {
    ...
    if (isset($_POST['entriemoddelete_check']) && $_POST['entriemoddelete_check']!="") {
        ...
        //echo "entriemod_entrieid: ".$_POST['entriemod_entrieid'];
