...
if (isset($_POST['filterline_submit'])) {
    ...
    //szűrés változók kiírása
    //echo "filterline_categoryfilter: ".$_POST['filterline_categoryfilter']."<br>"; echo "filterline_arrangment: ".$_POST['filterline_arrangment']."<br>";
...
//echo "<br>-----<br>"; print_r($blogslist); die('qwe');
?>
